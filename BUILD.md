...
```bash
tar -C dist -czf dist/csm-linux-amd64-0.2.3.tar.gz csm-linux-amd64
tar -C dist -czf dist/csm-darwin-amd64-0.2.3.tar.gz csm-darwin-amd64
tar -C dist -czf dist/csm-darwin-arm64-0.2.3.tar.gz csm-darwin-arm64
(cd dist && zip -q csm-windows-amd64-0.2.3.zip csm-windows-amd64.exe)
```
